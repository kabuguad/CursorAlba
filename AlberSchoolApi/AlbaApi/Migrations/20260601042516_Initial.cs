        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Slug = table.Column<string>(type: "TEXT", nullable: false),
                    Name = table.Column<string>(type: "TEXT", nullable: false),
                    Ages = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Tuition = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: false),
                    Transport = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: false),
                    Activities = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: false),
                    SortOrder = table.Column<int>(type: "INTEGER", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PublicFeeRows", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplyingForClassId = table.Column<int>(type: "INTEGER", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Applications_Classes_ApplyingForClassId",
                        column: x => x.ApplyingForClassId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Applications_ApplyingForClassId",
                table: "Applications",
                column: "ApplyingForClassId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Grades_StudentId_SubjectId_AssessmentDate_AssessmentType",
                table: "Grades",
                columns: new[] { "StudentId", "SubjectId", "AssessmentDate", "AssessmentType" },
                unique: true);
