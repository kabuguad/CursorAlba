  ...
  return (
    <div className="overflow-hidden">
      ...
      <section
        ...
        style={{
          backgroundImage: `url('https://picsum.photos/seed/alber-admissions/1600/900')`,
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-6 py-20 text-center">
          <motion.div initial={{ opacity: 0, y: 32 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <span className="mb-4 inline-flex items-center gap-2 rounded-full border border-gold/40 bg-gold/10 px-4 py-1 text-xs font-bold uppercase tracking-widest text-gold">
              <span className="h-1.5 w-1.5 rounded-full bg-gold" />2026 · 2027 Intake Open
            </span>
            <h1 className="mt-4 text-5xl font-extrabold text-white md:text-7xl">{get('hero.headline', 'Admissions')}</h1>
            <p className="mx-auto mt-6 max-w-2xl text-lg text-white/70">{get('hero.subheadline', 'Join Alber School — applications open for 2026/2027 intake. Limited spaces available.')}</p>
          </motion.div>
        </div>
      </section>
