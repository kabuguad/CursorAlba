  ...
  return (
    <>
      ...
      <article className="mx-auto max-w-3xl px-4 py-12">
        ...
        <img src={post.image} alt={post.title} className="mb-8 w-full rounded-3xl object-cover aspect-video" />
        <span className="text-sm font-semibold text-gold">{post.category} · {post.date}</span>
